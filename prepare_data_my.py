...
def main(args, bm):
    ...
    # 'MPI_HDM05', 'BioMotionLab_NTroje', 'CMU', 'ACCAD', 'BMLmovi','EKUT', 'Eyes_Japan_Dataset',
    #                             'KIT', 'MPI_Limits', 'MPI_mosh', 'SFU', 'TotalCapture'
    for dataroot_subset in ['BioMotionLab_NTroje_remove', 'MPI_HDM05_remove']:
        ...
        split_file = os.path.join(
            "prepare_data/data_split", dataroot_subset + "_split.txt"
        )
        ...
        for filepath in tqdm(filepaths):
            ...
            bdata_dmpls = bdata['dmpls'][::stride, ...]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--support_dir",
        type=str,
        default="/remote-home/fenghan/3drepo/VqDiffusion396/body_models",
        help="=dir where you put your smplh and dmpls dirs",
    )
    parser.add_argument(
        "--save_dir",
        type=str,
        default="/remote-home/share/fhan/AMASS_FULL",
