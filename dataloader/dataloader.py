...
def get_motion(motion_list):
    ...
    # hmd_position_global_full_gt_list: 3 joints(head, hands) 6d rotation/6d rotation velocity/3d global translation/3d global translation velocity
...
def get_path(dataset_path, split, protocol):
    ...
    assert protocol in ['1_small_dataset', '2_BMLtest', '2_CMUtest', '2_MPItest', '3_full_dataset', 'real',
                        'randomsplit_0']
